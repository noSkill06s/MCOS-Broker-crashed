...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Setzen der Startposition des Pickers auf "Chart" (Index 2)
        pickerview.selectRow(2, inComponent: 0, animated: false)
        
        // Verstecken oder Anzeigen der entsprechenden Child-ViewControllers
        childDepotViewController.view.isHidden = true
        childWatchlistViewController.view.isHidden = true
        childChartViewController.view.isHidden = false // Beim Start anzeigen
