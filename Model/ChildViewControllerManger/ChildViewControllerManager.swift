...
func setupChildViewControllers(for parentVC: HomeViewController) {
    ...
    // Schritt 5: Anfangszustand festlegen
    parentVC.childDepotViewController.view.isHidden = true
    parentVC.childWatchlistViewController.view.isHidden = true
    parentVC.childChartViewController.view.isHidden = false
    parentVC.childTCRViewController.view.isHidden = true
    ...
    // Schritt 7: Größe und Position für childDepotViewController
    ...
    // Schritt 7: Größe und Position für childWatchlistViewController
    ...
    // Schritt 7: Größe und Position für childChartViewController
    ...
    // Schritt 7: Größe und Position für childTCRViewController
